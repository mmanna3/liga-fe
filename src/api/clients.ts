...
export class Client {
  ...
  protected processPlanillasDeJuego(
    response: Response
  ): Promise<PlanillaDeJuegoDTO> {
    const status = response.status
    let _headers: any = {}
  ...
  protected processEliminacionDirecta(
    response: Response
  ): Promise<EliminacionDirectaDTO> {
    const status = response.status
    let _headers: any = {}
  ...
  protected processConfiguracionesPorIds(
    response: Response
  ): Promise<ConfiguracionDTO[]> {
    const status = response.status
    let _headers: any = {}
  ...
  protected processConfiguracionAll(
    response: Response
  ): Promise<ConfiguracionDTO[]> {
    const status = response.status
    let _headers: any = {}
   ...
   */
  configuracionPOST(
    body: ConfiguracionDTO | undefined
  ): Promise<ConfiguracionDTO> {
    let url_ = this.baseUrl + '/api/Configuracion'
    url_ = url_.replace(/[?&]$/, '')
  ...
  protected processConfiguracionPOST(
    response: Response
  ): Promise<ConfiguracionDTO> {
    const status = response.status
    let _headers: any = {}
  ...
  protected processConfiguracionGET(
    response: Response
  ): Promise<ConfiguracionDTO> {
    const status = response.status
    let _headers: any = {}
   ...
   * @return OK
   */
  gruposDeFasesCambiarVisibilidadEnApp(
    padreId: number,
    id: number,
    body: CambiarVisibilidadEnAppDTO | undefined
  ): Promise<void> {
    let url_ =
      this.baseUrl +
      '/api/Torneo/{padreId}/grupos-de-fases/{id}/visibilidad-en-app'
    if (padreId === undefined || padreId === null)
      throw new Error("The parameter 'padreId' must be defined.")
    url_ = url_.replace('{padreId}', encodeURIComponent('' + padreId))
    if (id === undefined || id === null)
    ...
    return this.http.fetch(url_, options_).then((_response: Response) => {
      return this.processGruposDeFasesCambiarVisibilidadEnApp(_response)
    })
  }

  protected processGruposDeFasesCambiarVisibilidadEnApp(
    response: Response
  ): Promise<void> {
    const status = response.status
    let _headers: any = {}
...
export class ArbitroElegibleAsignacionDTO implements IArbitroElegibleAsignacionDTO {
  ...
  jornadasEnUltimasFechas?: JornadaAsignadaRecienteDTO[] | undefined
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data['jornadasEnUltimasFechas'])) {
        this.jornadasEnUltimasFechas = [] as any
        for (let item of _data['jornadasEnUltimasFechas'])
          this.jornadasEnUltimasFechas!.push(
            JornadaAsignadaRecienteDTO.fromJS(item)
          )
      }
    }
  }
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.jornadasEnUltimasFechas)) {
      data['jornadasEnUltimasFechas'] = []
      for (let item of this.jornadasEnUltimasFechas)
        data['jornadasEnUltimasFechas'].push(item.toJSON())
    }
    return data
  }
}
...
export class JornadaAsignadaRecienteDTO implements IJornadaAsignadaRecienteDTO {
  zonaId!: number
  jornadaId!: number
  ...
  constructor(data?: IJornadaAsignadaRecienteDTO) {
    if (data) {
      for (var property in data) {
        if (data.hasOwnProperty(property))
          (<any>this)[property] = (<any>data)[property]
  ...
  static fromJS(data: any): JornadaAsignadaRecienteDTO {
    data = typeof data === 'object' ? data : {}
    let result = new JornadaAsignadaRecienteDTO()
    result.init(data)
    return result
  }
...
export interface IJornadaAsignadaRecienteDTO {
  zonaId: number
  jornadaId: number
  fechaNumero?: number | undefined
  instanciaNombre?: string | undefined
