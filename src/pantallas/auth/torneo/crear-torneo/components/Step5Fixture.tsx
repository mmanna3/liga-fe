...
export function Step5Fixture() {
  ...
  const [bracketParticipants, setBracketParticipants] = useState<Array<{
    id: number
    name: string
    club: string
    tournament: string
  ...
  const useZoneMode = (isAllVsAll || isElimination) && zonesWithTeams.length > 0
  ...
  const buildParticipants = (
    ...
    const placeholders = shuffle([
      ...
      ...Array.from({ length: interzonal }, (_, i) => INTERZONAL_PLACEHOLDER(i))
    ])
